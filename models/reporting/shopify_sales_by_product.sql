...
SELECT 
    ...
    SUM(COALESCE(first_quantity,0)) as first_quantity,
    SUM(COALESCE(repeat_quantity,0)) as repeat_quantity,
    SUM(COALESCE(net_quantity,0)) as net_quantity,
    SUM(COALESCE(first_net_quantity,0)) as first_net_quantity,
    SUM(COALESCE(repeat_net_quantity,0)) as repeat_net_quantity,
